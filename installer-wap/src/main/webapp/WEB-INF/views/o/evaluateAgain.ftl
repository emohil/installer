...
<body ng-controller="EvaluateController">
  ...
  <div id="photoShow"
    ...
    <div class="my-gallery" itemscope>
      ...
      indentNodeStep.imgUrlList as imgUrl>
      <figure itemprop="associatedMedia" itemscope>
        <a href="${imgUrl}" itemprop="contentUrl" data-size="1024x683">
          <img src="${imgUrl}" itemprop="thumbnail"
  ...
  <form>
    ...
    <button id="button1" type="button" ng-click="save();">提&nbsp;&nbsp;&nbsp;&nbsp;交</button>
  </form>
  ...
  <script src="static/scripts/o/evaluateAgain.js"></script>
