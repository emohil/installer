...
public interface WxMpService {
     ...
     *            强制刷新
     * @return
     * @throws com.company.wx.common.exception.WxErrorException
     */
     ...
     * 
     * @param mediaType
     *            媒体类型, 请看{@link com.company.wx.common.api.WxConsts}
     * @param fileType
     *            文件类型，请看{@link com.company.wx.common.api.WxConsts}
     * @param inputStream
     *            输入流
     * @throws WxErrorException
     */
     ...
     *            媒体类型, 请看{@link com.company.wx.common.api.WxConsts}
     * @param material
     *            上传的素材, 请看{@link com.company.wx.mp.bean.WxMpMaterial}
     * @return
     * @throws WxErrorException
     */
     ...
     * 
     * @param news
     *            上传的图文消息, 请看{@link com.company.wx.mp.bean.WxMpMaterialNews}
     * @return
     * @throws WxErrorException
     */
     ...
     *            用来更新图文素材的bean, 请看
     *            {@link com.company.wx.mp.bean.WxMpMaterialArticleUpdate}
     * @return
     * @throws WxErrorException
     */
     ...
     * @param news
     * @throws WxErrorException
     * @see #massGroupMessageSend(com.company.wx.mp.bean.WxMpMassGroupMessage)
     * @see #massOpenIdsMessageSend(com.company.wx.mp.bean.WxMpMassOpenIdsMessage)
     */
     ...
     * <pre>
     * 分组群发消息
     * 如果发送图文消息，必须先使用 {@link #massNewsUpload(com.company.wx.mp.bean.WxMpMassNews)} 获得media_id，然后再发送
     * 如果发送视频消息，必须先使用 {@link #massVideoUpload(com.company.wx.mp.bean.WxMpMassVideo)} 获得media_id，然后再发送
     * 详情请见: http://mp.weixin.qq.com/wiki/index.php?title=高级群发接口
     * </pre>
     * 
     * @param message
     ...
     * 可以参考，{@link com.company.wx.common.util.http.MediaUploadRequestExecutor}的实现方法
     * </pre>
     * 
     * @param executor
     * @param uri
     ...
     * @return
     * @deprecated Use
     *             com.company.wx.mp.api.WxMpService.getPrepayId(Map<String,
     *             String>) instead
     */
    @Deprecated
     ...
     * 详见http://mp.weixin.qq.com/wiki/7/aaa137b55fb2e0456bf8dd9148dd613f
     * .html#.E5
     * .8F.91.E8.B5.B7.E4.B8.80.E4.B8.AA.E5.BE.AE.E4.BF.A1.E6.94.AF.E4.BB
     * .98.E8.AF.B7.E6.B1.82
     * 
     * @param parameters
     ...
     * @return
     * @deprecated Use
     *             com.company.wx.mp.api.WxMpService.getJSSDKPayInfo(Map<String
     *             , String>) instead
     */
    @Deprecated
