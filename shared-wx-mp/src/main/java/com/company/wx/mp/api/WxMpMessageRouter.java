...
import com.company.wx.common.api.WxMessageDuplicateChecker;
import com.company.wx.common.api.WxMessageInMemoryDuplicateChecker;
import com.company.wx.common.session.InternalSession;
import com.company.wx.common.session.InternalSessionManager;
import com.company.wx.common.session.StandardSessionManager;
import com.company.wx.common.session.WxSessionManager;
import com.company.wx.common.util.LogExceptionHandler;
...
public class WxMpMessageRouter {
    ...
    /**
     * <pre>
     * 设置自定义的 {@link com.company.wx.common.api.WxMessageDuplicateChecker}
     * 如果不调用该方法，默认使用 {@link com.company.wx.common.api.WxMessageInMemoryDuplicateChecker}
     * </pre>
     * 
    ...
    /**
     * <pre>
     * 设置自定义的{@link com.company.wx.common.session.WxSessionManager}
     * 如果不调用该方法，默认使用 {@link com.company.wx.common.session.StandardSessionManager}
     * </pre>
     * 
    ...
    /**
     * <pre>
     * 设置自定义的{@link com.company.wx.common.api.WxErrorExceptionHandler}
     * 如果不调用该方法，默认使用 {@link com.company.wx.common.util.LogExceptionHandler}
     * </pre>
     * 
    ...
    protected boolean isDuplicateMessage(WxMpXmlMessage wxMessage) {
        ...
        if (wxMessage.getMsgId() == null) {
            messageId = String.valueOf(wxMessage.getCreateTime()) + "-" + wxMessage.getFromUserName() + "-"
