package com.company.web.fs.controller;
...
@Controller("webFileManagerController")
...
public class FileManagerController {
    ...
    @ResponseBody
    public void delete(HttpServletRequest request, HttpServletResponse response, String fileid) {
